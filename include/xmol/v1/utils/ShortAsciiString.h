...
namespace std {
template <int N, bool ALLOW_TRUNC, typename T> struct hash<xmol::v1::utils::ShortAsciiString<N, ALLOW_TRUNC, T>> {
  using argument_type = xmol::v1::utils::ShortAsciiString<N, ALLOW_TRUNC, T>;
