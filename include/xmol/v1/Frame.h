...
public:
  ...
  [[nodiscard]] size_t n_residue_references() const { return selection::Observable<proxy::smart::ResidueSmartRef>::observers.size(); }
  [[nodiscard]] size_t n_molecule_references() const { return selection::Observable<proxy::smart::MoleculeSmartRef>::observers.size(); }
