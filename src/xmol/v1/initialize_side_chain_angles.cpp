...
//};
//std::optional<TorsionAngleFactory::residue_to_atoms> make_atoms_refs(const char* a, const char* b, const char* c,
//                                                                     const char* d) {
//  return {}; //[a, b, c, d](proxy::ResidueRef&) { return std::optional<TorsionAngleFactory::residue_to_atoms>{}; };
//};
//
