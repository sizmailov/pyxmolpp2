...
residueIndex_t Residue::pos_in_parent() const {
  return static_cast<residueIndex_t>(this-chain().elements.data());
}
...
chainIndex_t Chain::pos_in_parent() const {
  return static_cast<chainIndex_t>(this-frame().elements.data());
}
