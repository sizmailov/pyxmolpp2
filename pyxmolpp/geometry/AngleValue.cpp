...
void pyxmolpp::geometry::init_AngleValue(pybind11::module& geometry) {
  ...
  geometry.def("degrees_to_radians", degrees_to_radians);
  geometry.def("radians_to_degrees", radians_to_degrees);
...
//      .def(py::self -= py::self)
  ...
  geometry.def("Degrees", [](double value){return AngleValue(Degrees(value));},py::return_value_policy::copy);
  geometry.def("Radians", [](double value){return AngleValue(Radians(value));},py::return_value_policy::copy);


  geometry.def("sin", xmol::geometry::sin,py::return_value_policy::copy);
  geometry.def("cos", xmol::geometry::cos,py::return_value_policy::copy);
  geometry.def("tan", xmol::geometry::tan,py::return_value_policy::copy);
  geometry.def("fabs", xmol::geometry::fabs,py::return_value_policy::copy);
